...
import { Observer as AstroObserver, Horizon as AstroHorizon } from 'astronomy-engine';
    ...
    <div className="bg-slate-950/40 border border-slate-800/60 rounded-xl p-5 shadow-2xl h-full flex flex-col justify-between backdrop-blur-md" id="skyview-observatory-dome">
      ...
      <div className="flex items-center justify-between mb-4 border-b border-slate-900 pb-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-bold uppercase tracking-widest text-slate-300 font-mono">Scope Radar Planisphere</h2>
        </div>
        <div className="bg-slate-900/80 border border-emerald-500/20 rounded-lg px-2.5 py-1 text-xs font-mono flex items-center gap-2 text-slate-400">
      ...
      <div className="bg-slate-900/40 border border-slate-800/60 rounded-lg p-2.5 mb-3 flex flex-col gap-2.5" id="bortle-darkness-controls">
        <div className="flex items-center justify-between">
          <span className="text-xs uppercase font-mono tracking-wider text-slate-400 font-semibold flex items-center gap-1">
            <Radio className="w-3.5 h-3.5 text-indigo-400 animate-pulse" />
            Bortle Sky Darkness Scale
          </span>
          <span className="text-xs font-mono font-bold text-indigo-300 bg-indigo-950/60 border border-indigo-800/40 px-2 py-0.5 rounded uppercase">
            Class {bortleScale}: {
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-3">
            <span className="text-xs font-mono text-emerald-400 font-bold">DARK (1)</span>
            <input
              type="range"
              min="1"
              max="9"
              ...
              id="bortle-slider"
            />
            <span className="text-xs font-mono text-amber-500 font-bold">GLARE (9)</span>
          </div>
          <span className="text-xs font-mono text-slate-400 leading-normal block">
        ...
        <div>
          <span className="text-xs uppercase font-mono tracking-wider text-slate-400 font-semibold flex items-center gap-1.5 mb-2">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              ...
              className={`py-1 px-2 rounded text-xs font-mono font-bold transition-all cursor-pointer border flex items-center justify-between ${
                showStars 
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <div
              className={`py-1.5 px-2 rounded text-xs font-mono font-bold border flex items-center justify-between bg-indigo-950/20 border-indigo-500/20`}
            ...
            <button
              ...
              className={`py-1.5 px-2 rounded text-xs font-mono font-bold transition-all cursor-pointer border flex items-center justify-between ${
                showAudioPings 
      ...
      {cityLightsFilter && (
        <div className="mx-2.5 bg-amber-950/35 border border-amber-500/25 rounded-lg p-2 text-xs font-mono text-amber-500 flex items-center gap-2 select-none pointer-events-none uppercase tracking-wide leading-tight">
      ...
      >
        <svg
          ...
          className="max-w-[480px] max-h-[480px] w-full h-auto aspect-square overflow-visible"
        >
          <defs>
          ...
          <g className="font-mono text-[12px] font-bold fill-slate-500">
          ...
          <g className="font-mono text-[10px] font-bold fill-slate-600 select-none">
          ...
          <g className="font-mono text-[13px] font-bold fill-emerald-500/80">
            <text x="0" y={-radius - 8} textAnchor="middle">N</text>
            <text x={radius + 12} y="3.5" textAnchor="middle">E</text>
            <text x="0" y={radius + 16} textAnchor="middle">S</text>
            <text x={-radius - 12} y="3.5" textAnchor="middle">W</text>
          </g>
        ...
        <div className="absolute top-2 left-2 text-xs font-mono text-slate-400 bg-slate-950/80 px-2.5 py-1 rounded border border-slate-800/50 flex items-center gap-1.5 pointer-events-none shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
      ...
      <div className="border-t border-slate-900 pt-3">
        <span className="text-xs font-semibold text-slate-500 font-mono tracking-wider block mb-2 uppercase">LOCKED FEED SIGNATURES:</span>
